...
<div class = nav_container>
    <div class="width_wrapper_div">
        ...
        <a href="/productservlet?type=brand&value=Nubia" style="text-decoration: none" class="brand_items">
            <div class="text_div underlinestroke">Nubia</div>
        </a>

        <c:choose>
            <c:when test="${not empty Username}">
                <a href="/views/profile" style="text-decoration: none" class="text_div underlinestroke">${Username}</a>
            </c:when>
            <c:otherwise>
                <a href="/views/LoginPage.jsp" style="text-decoration: none" class="text_div">Đăng Nhập</a>
            </c:otherwise>
        </c:choose>
        <div class="icon_div " id="iconSearch" onclick="toggleIconSearch()" >
        ...
        <a href="/views/cart" class="icon_div ">
        ...
        <c:choose>
            <c:when test="${not empty Username}">
                <a href="/views/logout" style="text-decoration: none" class="text_div underlinestroke">Đăng xuất</a>
            </c:when>
            <c:otherwise>
                <a href="#" style="display: none" class="text_div"></a>
            </c:otherwise>
        </c:choose>
    </div>
</div>
